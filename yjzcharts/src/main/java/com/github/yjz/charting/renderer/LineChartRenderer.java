...
//                Log.e("ludak","drawLinear trans before : "+e1+"，"+Arrays.toString(mLineBuffer));

                if (j > 0) {
                    trans.pointValuesToPixel(mLineBuffer);

//                    Log.e("ludak","drawLinear trans after : "+e1+"，"+Arrays.toString(mLineBuffer));
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            // draw the lines
            drawHighlightLines(c, (float) pix.x, (float) pix.y, set,mChart);
        }
    }
