    ...
    public void renderAxisLabels(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentTop() - yoffset - mXAxis.getLongScaleLineLength(), pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentTop() + yoffset + mXAxis.mLabelRotatedHeight + mXAxis.getLongScaleLineLength(), pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentBottom() + yoffset + mXAxis.getLongScaleLineLength(), pointF);
            }else{
            ...
            if (mXAxis.isDrawScale()){
                drawLabels(c, mViewPortHandler.contentBottom() - yoffset - mXAxis.mLabelRotatedHeight  - mXAxis.getLongScaleLineLength(), pointF);
            }else{
    ...
    protected void drawScale(Canvas canvas, float startX, float offset) {
        ...
        if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM) { //X轴位置在下方时
            for (int i = 0; i <= 5; i++) {
                ...
                if (i % 5 == 0) {
                    canvas.drawLine(startX, bottomY + mXAxis.getLongScaleLineLength(), startX, bottomY, mAxisScaleLinePaint);//画长刻度线
                } else {
                    canvas.drawLine(startX, bottomY +  mAxis.getShortScaleLineLength(), startX, bottomY, mAxisScaleLinePaint);//画短刻度线
                }
                canvas.restore();
            }
        } else if (mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM_INSIDE){
            ...
            for (int i = 0; i <= 5; i++) {
                ...
                canvas.translate(offset * i, 0);
                if (i % 5 == 0) {
                    canvas.drawLine(startX, topY - mXAxis.getLongScaleLineLength(), startX, topY, mAxisScaleLinePaint);//画长刻度线
                } else {
                    canvas.drawLine(startX, topY -  mAxis.getShortScaleLineLength(), startX, topY, mAxisScaleLinePaint);//画短刻度线
                }
                canvas.restore();
            }
        } else if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP_INSIDE){
            ...
            for (int i = 0; i <= 5; i++) {
                ...
                if (i % 5 == 0) {
                    //画长刻度线
                    canvas.drawLine(startX, topY + mXAxis.getLongScaleLineLength(), startX, topY, mAxisScaleLinePaint);//顶部X轴的刻度
                    canvas.drawLine(startX, bottomY + mXAxis.getLongScaleLineLength(), startX, bottomY, mAxisScaleLinePaint);//底部X轴的刻度
                } else {
                    //画短刻度线
                    canvas.drawLine(startX, topY + mAxis.getShortScaleLineLength(), startX, topY, mAxisScaleLinePaint);//顶部X轴的刻度
                    canvas.drawLine(startX, bottomY +  mAxis.getShortScaleLineLength(), startX, bottomY, mAxisScaleLinePaint);//底部X轴的刻度
                }
                canvas.restore();
            }
        }
