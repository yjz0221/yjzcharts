...
public abstract class AxisBase extends ComponentBase {
     ...
     * 长刻度线的长度
     */
    protected float mLongScaleLineLength = Utils.convertDpToPixel(10f);


    /**
     * 短刻度线的长度
     */
    protected float mShortScaleLineLength = Utils.convertDpToPixel(7f);
    ...
    public float getLongScaleLineLength() {
        return mLongScaleLineLength;
    }

    public void setLongScaleLineLength(float longScaleLineLength) {
        this.mLongScaleLineLength = longScaleLineLength;
    }

    public float getShortScaleLineLength() {
        return mShortScaleLineLength;
    }

    public void setShortScaleLineLength(float shortScaleLineLength) {
        this.mShortScaleLineLength = shortScaleLineLength;
    }
}
