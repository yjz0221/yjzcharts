...
package com.github.yjz.charting.utils;
...
import com.github.yjz.charting.interfaces.datasets.IBubbleDataSet;
...
public class Transformer {
     ...
     */
    //将原始的数据转换成屏幕像素，需借助内容绘制区域大小、平移缩放大小
    protected Matrix mMatrixValueToPx = new Matrix();

    /**
     * matrix for handling the different offsets of the chart
     */
    //用于计算内容绘制区域大小的offset矩阵，借助坐标轴的offset和外界设置的offset
